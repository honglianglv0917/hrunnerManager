...
if DEBUG:
    DATABASES = {
        'default': {
            ...
            'USER': 'root',  # 数据库登录名
            'PASSWORD': 'asus123',  # 数据库登录密码
            'HOST': '192.168.9.1',  # 数据库所在服务器ip地址
...
BROKER_URL = 'amqp://bove:123@192.168.9.128:5672//' if DEBUG else 'amqp://bove:123@192.168.9.128:5672//'
...
EMAIL_SEND_USERNAME = '1quanwang.yin@hstong.com'  # 定时任务报告发送邮箱，支持163,qq,sina,企业qq邮箱等，注意需要开通smtp服务
EMAIL_SEND_PASSWORD = '1TANGxinbing135!'     # 邮箱密码
